...
public class WristIOTalonFX implements WristIO{
    ...
    LoggedTunableNumber kS = new LoggedTunableNumber("Wrist/kS", 0.35);
    LoggedTunableNumber kV = new LoggedTunableNumber("Wrist/kV", 0);
    LoggedTunableNumber kG = new LoggedTunableNumber("Wrist/kG", 0.3);
    ...
    public void moveWrist(){
        wrist.setControl(motionMagicRequest.withPosition(Conversions.DegreesToRotations(setPoint, Constants.Wrist.gearRatio)).withFeedForward(kG.get()*Math.cos((getWristPos()*Math.PI)/180.0)));
    }
